...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://travel-sphere-zeta.vercel.app/post/view/${dataProfile._id}`, {
        headers: {
    ...
    axios
      .get(`https://travel-sphere-zeta.vercel.app/liveupdate/view/${dataProfile._id}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
        },
      })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://travel-sphere-zeta.vercel.app/user/update/${dataProfile._id}`,
        formValues,
        {
          headers : {
            'Authorization' : `Bearer ${token}`
